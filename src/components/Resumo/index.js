    ...
    return (
        <>
            <Descricao>
                ...
                Adicionalmente, tem experiênia nas áreas de Ciência de Dados: Processamento de Linguagem Natural (NLP), Reconhecimento Automático de Fala (ASR) e Aprendizado de Máquina (ML).
            </Descricao>
        </>
    )
}
