    ...
    return (
        <>
            <Descricao>
                ...
                Adicionalmente, tem experiência nas áreas de Ciência de Dados: Processamento de Linguagem Natural (NLP) e Aprendizado de Máquina (ML).
            </Descricao>
        </>
    )
}
